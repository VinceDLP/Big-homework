...
$key = trim($_POST["a"]);
$key_arr = explode("#",$key);
$cinema_name = $key_arr[2];
?>
<h4 id = "area1_name" ><?php echo $key_arr[3]; ?></h4>
    ...
    <div class="center-wrap">
            ...
            <ul class="filter-select">
                <li>
                    ...
                    if($key_arr[3] == "全部区域") {
                        ...
                        <div class="select-tags">
                            <a href="javascript:;" id="area1" onclick="ChooseArea(this)" class="current">全部区域</a>
                            <?php
                            include_once("../db/DbManage.php");
                            $db = new DbManage();
                ...
                <li>
                    ...
                    ?>
                        <div class="select-tags">
                            ...
                            $cinema_name = $key_arr[2];
                            while ($row = mysqli_fetch_array($result)) {
                                if($row["dyy_name"] == $cinema_name) {
                                    ?>
                                    <a href="javascript:;" class="current" onclick="cinema(this)"
                                    ><?php echo $row["dyy_name"] ?></a>
                                    <?php
                                }else{
                                    ?>
                                    <a href="javascript:;" onclick="cinema(this)" > <?php echo $row["dyy_name"] ?></a>
                                    <?php
                                }}
                            ?>
                        </div>
                ...
                <li>
                    ...
                    <div class="select-tags">
                        <?php
                        if($key_arr[1] == date("Y")."-".date("m")."-".date("d")){
                        ?>
                            ...
                            ?>
                            <a  href="javascript:;"  onclick="ChooseTime(this,1)" id = "time1"><?php echo  date("m")."月".date("d")."日"; ?>（今天）</a>
                            <a class="current" href="javascript:;"  onclick="ChooseTime(this,2)" name = "time2"><?php $d=strtotime("tomorrow");echo  date("m",$d)."月".date("d",$d)."日";?></a>
                            <?php
                        }
                        ?>
...
<div id = "plan">
    ...
    <h4 id = "data" ><?php echo $key_arr[1]?></h4>
    ...
    <div class="center-wrap" >
        <table class="hall-table">
            ...
            while($row = mysqli_fetch_array($result)) {
                ...
                if ($row["Dyy_id"] == $i && $row["data"] == $key_arr[1] && $row["Film_id"] == $key_arr[0]) {
