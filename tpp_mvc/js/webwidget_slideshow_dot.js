(function(a){
    a.fn.webwidget_slideshow_dot=function(p){
        ...
        function play(){
            ...
            x.find(".title_box").html(x.find(".slides_box").children("ul").children("li").children("a").eq(w).attr("href")+'" style="color:'+stc+'">'+x.find(".slides_box").children("ul").children("li").children("a").eq(w).attr("title")+'</a>');
